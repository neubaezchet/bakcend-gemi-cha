def get_confirmation_template(nombre, consecutivo, empresa, quinzena, link_pdf, archivos_nombres, email_contacto, telefono):
    """Template HTML para confirmacion de recepcion de incapacidad"""
    ...
    <head>
        ...
        <title>Confirmacion Incapacidad</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 40px 30px;">
                <h2 style="color: #333; margin-bottom: 20px;">Buen dia, {nombre}</h2>
                
                <div style="background: #f8f9fa; padding: 20px; border-left: 4px solid #667eea; margin: 25px 0; border-radius: 0 5px 5px 0;">
                    <p style="margin: 0; color: #333; line-height: 1.6;">
                        <strong>Confirmo recibido de la documentacion correspondiente</strong> y procederemos a <strong>realizar la revision</strong>. 
                        En caso de que cumpla con los requisitos establecidos, se realizara la carga en el sistema <strong>{quinzena}</strong>.
                    </p>
                </div>
                ...
                <div style="background: #fff3cd; border: 1px solid #ffeeba; padding: 20px; border-radius: 8px; margin: 25px 0;">
                    <p style="margin: 0; color: #856404; text-align: center; font-weight: bold;">
                        Estar pendiente via WhatsApp y correo para seguir en el proceso de radicacion si llegase a cumplir los requisitos establecidos, 
                        del contrario se notificara para su debida gestion.
                    </p>
                </div>
            </div>
...
def get_alert_template(tipo, cedula, consecutivo, email_contacto, telefono, nombre=None, empresa=None, link_pdf=None, archivos_nombres=None, quinzena=None):
    """Template HTML para alertas a supervision"""
    ...
    if tipo == "copia":
        ...
        <div style="background: white; border: 1px solid #e9ecef; padding: 20px; border-radius: 8px; margin: 25px 0;">
            <h4 style="margin-top: 0; color: #667eea;">Informacion del Empleado</h4>
            <table style="width: 100%; font-size: 14px;">
                <tr>
                ...
                <tr>
                    <td style="padding: 8px 0; color: #666; font-weight: bold;">Cedula:</td>
        ...
        titulo = "ALERTA: Cedula No Encontrada"
        contenido_principal = f"""
        <div style="background: #f8d7da; border: 1px solid #f5c6cb; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="color: #721c24; margin-top: 0;">Cedula No Registrada</h3>
            <p style="margin: 0; color: #721c24;">Se ha recibido documentacion de una cedula no encontrada en la base de datos.</p>
        </div>
        ...
        <div style="background: white; border: 1px solid #e9ecef; padding: 20px; border-radius: 8px; margin: 25px 0;">
            ...
            <table style="width: 100%; font-size: 14px;">
                ...
                <tr>
                    <td style="padding: 8px 0; color: #666; font-weight: bold;">Fecha recepcion:</td>
        ...
        <div style="background: #fff3cd; border: 1px solid #ffeeba; padding: 20px; border-radius: 8px; margin: 25px 0;">
            <p style="margin: 0; color: #856404; text-align: center; font-weight: bold;">
                ACCION REQUERIDA: Validar informacion y contactar al solicitante
            </p>
        </div>
        """
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <!-- Header -->
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px; font-weight: bold;">IncaNeurobaeza - Supervision</h1>
                <p style="margin: 5px 0 0 0; font-style: italic; opacity: 0.9;">Sistema de Gestion</p>
            </div>
            ...
            <div style="background: #f8f9fa; padding: 20px; text-align: center; border-top: 1px solid #e9ecef;">
                <div style="font-size: 12px; color: #6c757d;">
                    Sistema Automatico IncaNeurobaeza<br>
                    Notificacion de supervision
                </div>
            </div>
        </div>
    </body>
